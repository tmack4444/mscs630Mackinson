...
public class AESDeCipher {
 ...
 {0x52,	0x09,	0x6a,	0xd5,	0x30,	0x36,	0xa5,	0x38,	0xbf,	0x40,	0xa3,	0x9e,	0x81,	0xf3,	0xd7,	0xfb,
  ...
  public static String INV_aesSBox(String inHex){
    int coords = Integer.parseInt(inHex, 16);
    return Integer.toHexString(INV_S_BOX[coords]);
  }
  ...
  public static String galoisNineLookup(String inHex){
    int coords = Integer.parseInt(inHex, 16);
    return Integer.toHexString(MULT_NINE[coords]);
  }

  public static String galoisFourteenLookup(String inHex){
    int coords = Integer.parseInt(inHex, 16);
    return Integer.toHexString(MULT_FOURTEEN[coords]);
  }

  public static String galoisThirteenLookup(String inHex){
    int coords = Integer.parseInt(inHex, 16);
    return Integer.toHexString(MULT_THIRTEEN[coords]);
  }

  public static String galoisElevenLookup(String inHex){
    int coords = Integer.parseInt(inHex, 16);
    return Integer.toHexString(MULT_ELEVEN[coords]);
  }
  ...
  public static String[][] REV_AESNibbleSub(String[][] inStateHex){
    ...
    for(int i = 0; i < 4; i++ ){
      for(int j = 0; j < 4; j++ ){
        result[i][j] = INV_aesSBox(inStateHex[i][j]);
      }
    }
    return result;
  }
     ...
     int colTotal = 0;
       for(int m = 0; m < 4; m++){
         ...
         if(multVal == "02"){
           ...
           multVal = galoisNineLookup(inStateHex[c][m]);
           colTotal = colTotal ^ Integer.parseInt(multVal,16);

         }  else if (multVal == "14"){
           multVal = galoisFourteenLookup(inStateHex[c][m]);
           colTotal = colTotal ^ Integer.parseInt(multVal,16);

         }  else if (multVal == "13"){
           multVal = galoisThirteenLookup(inStateHex[c][m]);
           colTotal = colTotal ^ Integer.parseInt(multVal,16);

         }  else if (multVal == "11"){
           multVal = galoisElevenLookup(inStateHex[c][m]);
           colTotal = colTotal ^ Integer.parseInt(multVal,16);
